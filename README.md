...
[![Live Demo](https://img.shields.io/badge/demo-live-brightgreen)](https://gitsignal.pages.dev/)
...
GitHub doesn't make it easy to compare the vital signals of repositories: commit activity, contributor trends, issue velocity, and more. GitSignal gives you a single-page view of these metrics so you can make informed decisions about which projects are actively maintained and worth depending on.
...
git clone https://github.com/harshpreet93/gitsignal.git
cd gitsignal
...
GitSignal uses the GitHub API which limits unauthenticated requests to 60 per hour. To increase this limit to 5,000 requests per hour, add a GitHub personal access token using the "Add token" button. Your token is stored locally and never shared.
